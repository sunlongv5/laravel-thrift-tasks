...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'behavior' => [
            'driver'    => 'mysql',
            'host'      => env('DB_HOST_BEHAVIOR', ''),
            'database'  => env('DB_DATABASE_BEHAVIOR', ''),
            'username'  => env('DB_USERNAME_BEHAVIOR', ''),
            'password'  => env('DB_PASSWORD_BEHAVIOR', ''),
            'port'      => env('DB_PORT', 3306),
            'charset'   => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix'    => 'lie_',
        ...
        'bigdata' => [
            'driver'    => 'mysql',
            'host'      => env('DB_HOST', ''),
            'database'  => env('DB_DATABASE_MAIN_BIGDATA', ''),
            'username'  => env('DB_USERNAME_MAIN_BIGDATA', ''),
            'password'  => env('DB_PASSWORD_MAIN_BIGDATA', ''),
            'port'      => env('DB_PORT', 3306),
            'charset'   => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix'    => 'lie_',
